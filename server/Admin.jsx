...
// Generate 60 flat numbers per wing (Floors 1-12, Flats 01-05)
const FLAT_NUMBERS = [];
...
export default function Admin() {
  ...
  const fetchAllFlats = async () => {
    ...
    try {
      ...
      if (data.success) {
        // Map data by flat key e.g. "A-101" -> booking info
        const flatMap = {};
  ...
  return (
    <div style={styles.container}>
        ...
        <div style={styles.grid}>
          {FLAT_NUMBERS.map((num) => {
            ...
            return (
              <div 
                key={flatId} 
                onClick={() => setSelectedFlat(flatInfo)}
                style={{
                  ...styles.flatCard,
      ...
      {/* Selected Flat Modal / Details Panel */}
      {selectedFlat && (
...
const styles = {
  ...
  flatCard: { border: '1px solid', borderRadius: '8px', padding: '14px 8px', textAlign: 'center', cursor: 'pointer', transition: 'transform 0.1s' },
